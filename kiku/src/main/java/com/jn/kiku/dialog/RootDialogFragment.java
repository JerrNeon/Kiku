 ...
 * @Description: (根AppCompatDialogFragment)
 * @create by: chenwei
 * @date 2018/5/10 17:04
 */
public abstract class RootDialogFragment extends AppCompatDialogFragment implements LifecycleProvider<FragmentEvent>,
