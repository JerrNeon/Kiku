...
public class UnionPayManage implements Runnable, ILogToastView {
    ...
    private ProgressDialogFragment mProgressDialogFragment = null;//加载框
    ...
    public void startPay(@NonNull Activity activity, @NonNull UnionPayResultListener listener) {
        ...
        if (mProgressDialogFragment != null && activity instanceof AppCompatActivity)
            mProgressDialogFragment.show(((AppCompatActivity) activity).getSupportFragmentManager(), "tag");
    ...
    private class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            mProgressDialogFragment.cancel();
