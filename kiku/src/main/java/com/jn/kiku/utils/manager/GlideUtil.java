...
public class GlideUtil {
     ...
     * @param errorResourceId 错误图片
     */
    public static void displayImageWithRound(final Object context, final Object url, final ImageView imageView, final int placeholderResourceId, final int errorResourceId, final boolean isGif, final boolean isCache) {
        RequestOptions requestOptions = getRequestOptions(placeholderResourceId, errorResourceId, isCache);
        RequestManager requestManager = getRequestManager(context);
