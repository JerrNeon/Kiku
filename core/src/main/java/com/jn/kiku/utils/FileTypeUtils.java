...
public class FileTypeUtils {
    ...
    static {
        ...
        MIME_TYPE_MAP.put("audio/x-pn-realaudio-plugin", "rmp");
        MIME_TYPE_MAP.put("audio/x-pn-realaudio", "ram");
        MIME_TYPE_MAP.put("audio/x-ms-wma", "wma");
        ...
        MIME_TYPE_MAP.put("application/x-mpegURL", "m3u8");
        MIME_TYPE_MAP.put("video/MP2T", "ts");
        MIME_TYPE_MAP.put("video/3gpp", "3gp");
        MIME_TYPE_MAP.put("video/quicktime", "mov");
        MIME_TYPE_MAP.put("video/x-ms-wmv", "x-ms-wmv");
    ...
    public static String getFileMimeType(String filePath) {
        return FILE_TYPE_MAP.get(FileUtils.getFileSuffix(filePath).replace(".", ""));
    }
}
