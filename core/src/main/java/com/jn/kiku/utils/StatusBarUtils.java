...
public class StatusBarUtils {
     ...
     */
    public static int getStatusBarLightModeType(Activity activity) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
    ...
    public static void StatusBarLightMode(Activity activity) {
        StatusBarLightMode(activity, getStatusBarLightModeType(activity));
    }
    ...
    public static void StatusBarDarkMode(Activity activity) {
        StatusBarDarkMode(activity, getStatusBarLightModeType(activity));
    }
