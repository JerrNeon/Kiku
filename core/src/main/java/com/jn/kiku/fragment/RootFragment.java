 ...
 */
public abstract class RootFragment extends Fragment implements ILazyFragmentView, IUtilsView,
        IImageView, IBaseView, ILogToastView, IDisposableView, View.OnClickListener {
